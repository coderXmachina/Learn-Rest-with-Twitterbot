    ...
    Twitter.get('search/tweets', params, function(err, data) {
        ...
        if (!err) {
            ...
            if(typeof retweetId.entities.urls[0] != 'undefined'){
                var linkPostString = meConfig.quoteArray[Math.floor(Math.random() * 6)];
                ...
                var textPostString = meConfig.quoteArray[Math.floor(Math.random() * 6)];
                console.log("Back into the Warp to fight again another day. But can I see it though?\n\n");
